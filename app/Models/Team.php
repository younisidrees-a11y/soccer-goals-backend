...
class Team extends Model
{
    ...
    protected $fillable = [
        ...
        'stadium', 'stadium_capacity', 'venue_city', 'venue_address', 'venue_surface', 'venue_image_url', 'ground_history', 'manager', 'manager_facts', 'manager_bio', 'manager_photo_path',
        'coach_age', 'coach_nationality', 'coach_synced_at',
